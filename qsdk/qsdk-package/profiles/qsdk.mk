...
COREBSP_UTILS:=pm-utils qca-thermald-10.4 qca-qmi-framework qca-time-services dashboard \
...
define Profile/QSDK_Open
	...
	PACKAGES:=$(OPENWRT_STANDARD) $(STORAGE) \
		...
		qca-cnss-daemon $(CNSS_DIAG) \
		qrtr $(QMI_SAMPLE_APP) ath11k-qdss libtirpc
endef
